...
% Remove columns of S' except 1
X(:, [31:12:151 , 164:10:274] ) = [];
VarNames(:, [31:12:151 , 164:10:274] ) = [];

featuresBestCorr(X,VarNames,2);

% Remove column of QI Q wave amplitude (amplitude><width)
X(:, 149 ) = [];
VarNames(:,149) = [];

featuresBestCorr(X,VarNames,3);

% Remove column of AVL QRSA (AVL><DIII)
X(:, 190 ) = [];
VarNames(:,190) = [];
...
% Remove last columns that are correlated
